    ...
    <>
      <section className="hero-grid relative overflow-hidden border-b border-navy/10">
        <div className="section-wrap grid gap-12 py-20 md:grid-cols-[1.05fr_0.95fr] md:items-center md:py-28">
          ...
          <div className="relative min-h-[700px] md:min-h-[780px]">
            <div className="absolute inset-x-[18px] top-[18px] bottom-[6px] rounded-[1.5rem] border border-white/60 bg-gradient-to-br from-white via-[#EEF3F8] to-[#DDE8EE] shadow-[0_28px_70px_-34px_rgba(11,31,58,0.28)]" />
            <div className="absolute inset-x-8 top-8 bottom-2 rounded-[1.35rem] border border-navy/10 bg-navy p-10 text-white shadow-[0_30px_80px_-38px_rgba(11,31,58,0.6)] md:bottom-4 md:p-12">
            ...
            <div className="absolute -bottom-20 right-0 rounded-[1rem] border border-navy/10 bg-white/95 px-5 py-4 shadow-[0_20px_44px_-26px_rgba(11,31,58,0.3)] md:-bottom-18 md:-right-20 lg:-right-24 md:w-56">
