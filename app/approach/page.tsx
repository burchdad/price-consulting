    ...
    <section className="section-wrap py-16 md:py-24">
      ...
      <div className="mt-10 space-y-5">
        {phases.map((phase, index) => (
          <article key={phase.title} className="intel-panel p-6 shadow-panel md:flex md:items-start md:gap-6">
            <div className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-white/20 bg-navy text-sm font-semibold text-white">
              {index + 1}
            </div>
